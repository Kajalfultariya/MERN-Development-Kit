...
const CreateStudent = () => {
    ...
    const fetchStudentData = async () => {
        await axios.get("https://www.merndevelopmentkit.com/api/fetchStudent")
            .then((response) => {
    ...
    const fetchBookData = async () => {
        ...
        await axios.post("https://www.merndevelopmentkit.com/api/createStudent", newData)
            .then((response) => {
                navigate('/login')
            }).catch(error => { console.log("errr", error) })
    }
...
const Login = () => {
    ...
    const fetchBookData = async () => {
        await axios.get("https://www.merndevelopmentkit.com/api/fetchStudent").then((response) => {
...
const StudentLibraryManagement = () => {
  ...
  const fetchStudentData = async () => {
    await axios.get("https://www.merndevelopmentkit.com/api/fetchStudentOne/" + localStorage.getItem("studentId"))
      .then((response) => {
  ...
  const fetchBorrowBookData = async () => {
    await axios.get("https://www.merndevelopmentkit.com/api/fetchBook").then((response) => {
      if (response.data)
    ...
    books.map(async (book) => {
      if (book.id === id) {
        if (!book.available.includes(JSON.parse(localStorage.getItem("studentPersonalId")))) {
          ...
          //update book list
          await axios.put(https://www.merndevelopmentkit.com/api/update/\${bookId}, formData)
            .then((response) => { }).catch(error => { console.log("errr", error) })


          //add boorow book data
          await axios.post("https://www.merndevelopmentkit.com/api/createBook", newBorrow)
            .then((response) => {
            }).catch(error => { console.log("errr", error) })
          ...
          await axios.put(https://www.merndevelopmentkit.com/api/updateStudent/\${studentInfo._id}, formDataId)
            .then((response) => {
  ...
  const handleReturnBook = async (bookId, id) => {
    ...
    books.map(async (book) => {
      if (book.id === id) {
        ...
        //update book list
        await axios.put(https://www.merndevelopmentkit.com/api/update/\${book._id}, formData)
          .then((response) => {
        ...
        borrowedBooks.map(async (item) => (
          ...
          item.bookId === id && item.studentId === localStorage.getItem("studentId") ?
            await axios.delete(https://www.merndevelopmentkit.com/api/deleteBook/\${item._id})
              .then((res) => {
                                    ...
                                    <div className="modal-actions"
                                        ...
                                        <button className="setting-btn" onClick={async () => {
                                            if (!name || !email || !phone || !eId || !password) {
                                                ...
                                                await axios.put(https://www.merndevelopmentkit.com/api/updateStudent/\${studentInfo._id},
                                                    formData)
                                                    .then((response) => {
                                    ...
                                    <div className="modal-actions"
                                        ...
                                        <button className="setting-btn delete-btn"
                                            onClick={async () => {
                                                ...
                                                await axios.delete(https://www.merndevelopmentkit.com/api/deleteStudent/\${studentInfo._id})
                                                    .then((res) => {
                                                        navigate("/")
                                                    })
                                                    .catch(err => console.log(err))
            ...
            <button className="setting-btn"
              onClick={async () => {
                if (!title || !author || !category || !isbn || !year) {
                  ...
                  await axios.post("https://www.merndevelopmentkit.com/api/create",
                    formData)
                    .then((response) => {
                      toast.success("successfully updated Profile");
                      setModelShow(false)
