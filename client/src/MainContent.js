...
import CodeSlider2 from './CodeSlider2';
import CodeSlider3 from './CodeSlider3';

const MainContent = ({ contentRef, projectData, setProjectData,
    ...
    return (
        <main ref={contentRef} style={{ flex: 1, overflowY: "auto", display: "flex", flexDirection: "column", minWidth: 0 }}>
            {projectData === "Project1" && <CodeSlider />}
            {projectData === "Project2" && <CodeSlider2 />}
                    ...
                    <div style={{
                        ...
                        <div style={{ display: "flex", gap: 8, flexShrink: 0, flexWrap: "wrap" }}>
                            ...
                            {lessonContent.nextLesson && (
                                <button onClick={() => {
                                    goToLesson(lessonContent.nextLesson, activeModule)
